...
namespace Zooflix.Controllers
{
    ...
    public class FilmsController : ControllerBase
    {
        ...
        public FilmsController(ZooflixContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Film>>> GetFilm()
        {
          if (_context.Film == null)
          {
            ...
            return await _context.Film.Include("Etoiles").ToListAsync();
        }
        ...
        public async Task<ActionResult<Film>> PostFilm(Film film)
        {
          if (_context.Film == null)
          {
              return Problem("Entity set 'ZooflixContext.Film'  is null.");
          }
